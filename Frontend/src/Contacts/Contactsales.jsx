...
const Card = ({ icon, title, linkUrl }) => (
    <a href={linkUrl} className="block w-full">
        <div className="p-4 sm:p-5 md:p-6 flex flex-cols rounded-2xl m-2 shadow bg-white  dark:text-white hover:shadow-lg transition-shadow">
...
const App = () => (
    <div className="dark:bg-slate-900 dark:text-white pt-32 pb-10">
        <h1 className="text-4xl font-bold my-4 text-center">Contact Sales</h1>
        <p className="text-gray-700 mb-8 text-center dark:text-gray-300">

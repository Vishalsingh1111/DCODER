...
const ResourceCard = ({ title, description, buttonText, icon, link }) => {
    ...
    return (
        <a href={link} className="block group">
            <div className="border-t bg-[rgb(255,255,255)] shadow shadow-black/40 group hover:shadow-md hover:shadow-black/70 rounded-2xl transition-colors dark:bg-slate-900 dark:text-white dark:border dark:border-gray-600">
                ...
                <div className='bg-gradient-to-t from-[#fef3f3] to-white p-6 pt-1 rounded-2xl dark:from-slate-800'>

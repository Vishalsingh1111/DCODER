...
const ResourceCard = ({ title, description, buttonText, icon, link }) => (
    <a href={link} className="block group" >
        <div className="p-6 bg-white border-2 border-white shadow rounded-xl hover:border-red-500 transition-colors group dark:bg-slate-800 dark:text-white dark:border-none">
            ...
            <h2 className="mt-4 text-xl text-blue-900 font-bold dark:text-white">{title}</h2>
...
const ResourceGrid = () => (
    <div className="p-6 max-w-screen-xl container mx-auto md:px-20 px-4">
        <div className="pb-10 text-center ">
            <h1 className="font-semi-bold text-5xl pb-2" id='homecontentcard'>Free Offered Courses</h1>

    ...
    return (
        <div className="p-4 ">
            ...
            <div className="flex sm:flex-rows justify-center space-x-5">
                <div className="content-center bg-purple-500  h-[100px] text-white rounded p-4 border-t w-1/3">
                    <div className="text-xl font-bold">Languages</div>

                </div>
                <div className="content-center h-[100px] bg-purple-500 text-white shadow rounded p-4 border-t w-1/3">

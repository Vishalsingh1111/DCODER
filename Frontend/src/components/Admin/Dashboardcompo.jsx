    ...
    return (
        <div className="p-4 ">
            ...
            <div className="flex sm:flex-rows justify-center space-x-5">
                <div className="content-center bg-[#e7eaf6]  h-[100px] text-blue-800 rounded p-4 border-t w-1/3">
                    <div className="text-xl font-bold">Languages</div>

                </div>
                <div className="content-center h-[100px] bg-[#e7eaf6] text-blue-800 shadow rounded p-4 border-t w-1/3">

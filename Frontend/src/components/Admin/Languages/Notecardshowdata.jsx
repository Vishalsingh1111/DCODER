...
const NoteList = () => {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`${baseUrl}/note/${id}`);
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white p-8 rounded shadow-lg flex flex-col">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button className="bg-gray-300 shadow-lg hover:shadow-grey-500/30 shadow-black/30  text-gray-800 font-bold py-2 px-4 rounded" onClick={() => setDeleteNoteId(null)}>Cancel</button>
                        </div>
                    </div>
                </div>
            )}

...
//         const parts = text.split(/(<h1>|<\/h1>|<h2>|<\/h2>|<br\s*\/?>|<bg>|<\/bg>|<li>|<\/li>|<b>|<\/b>)/g).filter(Boolean);
//         let isH1 = false;
//         let isH2 = false;
//         let isBg = false;
//         let isLi = false;
...
//             } else {
//                 const content = (
//                     <span key={index} className={`${isH1 ? "text-black-500 text-2xl mb-10" : isH2 ? "text-gray-800 text-xl" : ""} ${isBold ? "font-bold text-gray-700" : ""}`}>
//                         {part.trim()}
//                     </span>
//                 );
//                 if (isBg) {
...
//     return (
//         <div className="p-4 bg-white dark:bg-slate-800 dark:text-white" style={{ fontFamily: '"Quicksand", sans-serif', fontWeight: '500' }}>
...
//             {item.example && (
//                 <div className="my-5">
//                     <div className="font-bold text-gray-500 mb-2">Example:</div>
//                     <div>{renderText(item.example)}</div>
//                 </div>
//             )}
//             {item.code && (
//                 <div className="my-5">
//                     <div className="mb-2">Show Code :Hide Code</div>
//                     <CodeSnippet codeString={item.code} />
//                 </div>
//             )}
//             {item.explanation && (
//                 <div className="mt-4">
//                     <div className="font-bold text-xl text-gray-500 mb-2">Explanation:</div>

...
const Projectcard = ({ item, onClick }) => {
    return (
        <div className='mx-auto max-w-screen-lg'>
            <div onClick={onClick}>
                <div className="h-full border-t dark:border shadow shadow-black/40 group dark:border-gray-600 hover:shadow-md hover:shadow-black/70 rounded-xl cursor-pointer hover:shadow-lg space-y-2 dark:bg-slate-900 dark:text-white">

...
const Projectcard = ({ item, onClick }) => {
    return (
        <div onClick={onClick} className="p-4 flex flex-col md:flex-row w-full md:w-[350px] cursor-pointer ">
            <div className="rounded-xl  md:p-5 hover:shadow-lg dark:bg-slate-800 dark:text-white dark:border-none bg-white border-gray-300 border ">
                <div className="mb-3 flex items-center justify-center">
                    {item.image1 && <img src={item.image1} alt="Project thumbnail" className=' dark:border-none' />}
                </div>

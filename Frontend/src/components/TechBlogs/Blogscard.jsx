        ...
        >
            <div className="content flex-1 flex flex-col justify-between">
                ...
                <div className="flex justify-start mt-4">
                    <a
                        className="text-purple-500 inline-block border p-2 rounded-lg border-purple-400 group-hover:bg-purple-500 group-hover:text-white group-hover:border-purple-500 transition-all duration-300"
                        href="#"
                    >
                        {"Click to open"} &rarr;
                    </a>

...
const Blogcard = ({ item, onClick }) => {
    return (
        <div
            onClick={onClick}
            className="relative p-5 border border-gray-400 bg-white min-h-[180px] m-5 flex flex-col md:flex-row w-full md:w-[350px] group hover:border-red-600 rounded-xl dark:border-none dark:bg-slate-800 dark:text-white cursor-pointer"
        >

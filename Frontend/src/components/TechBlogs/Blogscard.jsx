...
const Blogcard = ({ item, onClick }) => {
    return (
        <div
            onClick={onClick}
            className="relative border border-gray-300 group rounded-xl bg-[rgb(255,255,255)] min-h-[130px] m-5 flex flex-col w-full md:w-[350px] dark:border-gray-600 dark:border dark:bg-slate-900 dark:text-white cursor-pointer"
        >
            <div className="content flex flex-col flex-grow">
                <h3 className="text-xl font-[500] text-black dark:text-white p-5 pb-2">
                    {item.header}
                </h3>
                <div className="flex-grow p-5 pt-0 bg-gradient-to-t from-gray-200 to-[#ffffff] rounded-xl dark:from-slate-800">

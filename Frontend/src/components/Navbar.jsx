...
const Navbar = () => {
    ...
    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-none dark:text-white z-50 fixed top-0 left-0 ${sticky ? "sticky-navbar shadow-md bg-base-100 dark:bg-slate-900 dark:text-white duration-300 transition-all ease-in-out" : ""}`}>
            <div className="navbar">
                ...
                <div className="navbar-end space-x-4">
                    ...
                    <a href='/Ai'><div className='bg-red-800 rounded-lg px-3 py-2 text-white text-sm hover:bg-red-900'>Ask To AI</div></a>
                    {!authUser && (
                        <a href="/Login" className="bg-red-500 text-white px-3.5 py-1.5 rounded-md hover:bg-red-700 duration-300 cursor-pointer dark:bg-red-800">
                            Login
                        </a>
                    )}
                </div>

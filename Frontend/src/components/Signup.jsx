...
//                     <button className="flex items-center justify-center bg-white border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
//                         <img src="./public/images/google.png" alt="Google" className="h-5 w-5 mr-2" />
//                         Login with Google
//                     </button>
//                     <button className="flex items-center justify-center bg-white border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
//                         <img src="./public/images/facebook.png" alt="Facebook" className="h-7 w-7 mr-2" />
//                         Login with Facebook
//                     </button>
//                 </div>

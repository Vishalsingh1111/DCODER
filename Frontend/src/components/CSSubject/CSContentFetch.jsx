...
//                             <button
//                                 className="inline-flexjustify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white dark:bg-slate-800 text-sm font-medium text-gray-700 dark:text-white hover:bg-gray-50 dark:hover:bg-slate-700"
...
//                         {/* Dropdown menu */}
//                         {dropdownOpen && (
//                             <div className="absolute w-[500px] right-0 z-10 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
//                                 <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
//                                     <button
//                                         className={`block w-full text-left px-4 py-2 text-sm ${activeSection === "os" ? "text-red-500 bg-gray-100 dark:bg-slate-700" : "text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-700"}`}
//                                         onClick={() => {
...
//                                     </button>
//                                     <button
//                                         className={`block w-full text-left px-4 py-2 text-sm ${activeSection === "cn" ? "text-red-500 bg-gray-100 dark:bg-slate-700" : "text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-700"}`}
//                                         onClick={() => {
...
//                         <button className='bg-[#ffffff] text-sm dark:bg-slate-900 text-red-500 border border-red-500 px-4 py-3 rounded-md'>Download PDF</button>
//                     </a>
//                 </div>
//             </div>

//             <section className="max-w-screen-2xl container mx-auto py-5 md:px-20 px-4 relative z-20 overflow-hidden dark:bg-slate-900 dark:text-white lg:pb-[90px] lg:pt-[10px] text-center">

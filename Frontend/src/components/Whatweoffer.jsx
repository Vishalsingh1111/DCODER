...
const Service = () => {
    return (
        <>
            <Navbar />
            <section className="lg:pb-[10px] lg:pt-[50px] mt-20 max-w-screen-xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white">
                <div className="container mx-auto">
                    ...
                    <div className="-mx-4 flex flex-wrap dark:bg-slate-900 dark:text-white">
                        <ServiceCard
                            title="Interview Preparation "
                            details="Prepare effectively with our extensive collection of interview questions and expert-curated answers. Boost your confidence and readiness for technical interviews."
                            icon={
                                <svg
                                    width="36"
                                    height="36"
                        ...
                        <ServiceCard
                            title="DSA Sheets"
                            details="Master fundamental data structures and algorithms with our detailed sheets. Practice solving problems and strengthen your problem-solving skills."
                            icon={
                                <svg
                                    width="36"
                                    height="36"
                        ...
                        <ServiceCard
                            ...
                            details="Apply your learning with our diverse range of projects. From beginner to advanced levels, our projects offer practical experience and reinforce theoretical knowledge."
                            icon={
                                <svg
                                    width="36"
                                    height="36"
                        ...
                        <ServiceCard
                            ...
                            details="Stay updated with new content and resources. We continuously add fresh material to keep pace with industry advancements and user feedback."
                            icon={
                                <svg
                                    width="36"
                                    height="36"
